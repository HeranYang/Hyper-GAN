...
class cyclegan(object):
    def __init__(self, sess, args):
        ...
        self.latentEncodeScaleNet = latentEncodeScaleNet
        self.latentDecodeScaleNet = latentDecodeScaleNet
    ...
    def _build_model(self):
        ...
        self.latEnScl_A = self.latentEncodeScaleNet(self.real_codeA, self.options, False, name="generator_latEnSclNet")
        self.latEnScl_B = self.latentEncodeScaleNet(self.real_codeB, self.options, True, name="generator_latEnSclNet")
        self.latDeScl_A = self.latentDecodeScaleNet(self.real_codeA, self.options, False, name="generator_latDeSclNet")
        self.latDeScl_B = self.latentDecodeScaleNet(self.real_codeB, self.options, True, name="generator_latDeSclNet")
        
        # cycle of "real_A to fake_B to recon_A"
        self.encode_A = self.encoder_resnet(self.real_A, self.latEnScl_A, self.options, reuse=False, name="generator_encoder")
        self.fake_B = self.decoder_resnet(self.encode_A, self.latDeScl_B, self.options, reuse=False, name="generator_decoder")
        self.encode_fakeB = self.encoder_resnet(self.fake_B, self.latEnScl_B, self.options, reuse=True, name="generator_encoder")
        self.fake_A_ = self.decoder_resnet(self.encode_fakeB, self.latDeScl_A, self.options, reuse=True, name="generator_decoder")
        
        # cycle of "real_B to fake_A to recon_B"
        self.encode_B = self.encoder_resnet(self.real_B, self.latEnScl_B, self.options, reuse=True, name="generator_encoder")
        self.fake_A = self.decoder_resnet(self.encode_B, self.latDeScl_A, self.options, reuse=True, name="generator_decoder")
        self.encode_fakeA = self.encoder_resnet(self.fake_A, self.latEnScl_A, self.options, reuse=True, name="generator_encoder")
        self.fake_B_ = self.decoder_resnet(self.encode_fakeA, self.latDeScl_B, self.options, reuse=True, name="generator_decoder")
	    ...
	    # self reconstruction.
        self.recon_A = self.decoder_resnet(self.encode_A, self.latDeScl_A, self.options, reuse=True, name="generator_decoder")
        self.recon_B = self.decoder_resnet(self.encode_B, self.latDeScl_B, self.options, reuse=True, name="generator_decoder")
        ...
        self.latEnScl_test_A = self.latentEncodeScaleNet(self.test_codeA, self.options, True, name="generator_latEnSclNet")
        self.latEnScl_test_B = self.latentEncodeScaleNet(self.test_codeB, self.options, True, name="generator_latEnSclNet")
        self.latDeScl_test_A = self.latentDecodeScaleNet(self.test_codeA, self.options, True, name="generator_latDeSclNet")
        self.latDeScl_test_B = self.latentDecodeScaleNet(self.test_codeB, self.options, True, name="generator_latDeSclNet")
        
        self.encode_test_A = self.encoder_resnet(self.test_A, self.latEnScl_test_A, self.options, reuse=True, name="generator_encoder")
        self.fake_test_B = self.decoder_resnet(self.encode_test_A, self.latDeScl_test_B, self.options, reuse=True, name="generator_decoder")
        self.encode_test_B = self.encoder_resnet(self.test_B, self.latEnScl_test_B, self.options, reuse=True, name="generator_encoder")
        self.fake_test_A = self.decoder_resnet(self.encode_test_B, self.latDeScl_test_A, self.options, reuse=True, name="generator_decoder")
