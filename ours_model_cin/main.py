...
parser.add_argument('--epoch', dest='epoch', type=int, default=121, help='# of epoch')
...
parser.add_argument('--load_size1', dest='load_size1', type=int, default=170, help='scale images to this size')
parser.add_argument('--fine_size0', dest='fine_size0', type=int, default=240, help='then crop to this size')
parser.add_argument('--fine_size1', dest='fine_size1', type=int, default=160, help='then crop to this size')
...
parser.add_argument('--phase', dest='phase', default='train', help='train, valid or test')
